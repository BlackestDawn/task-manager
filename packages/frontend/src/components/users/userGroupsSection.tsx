        ...
        {groups.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">
              Groups can add members from their group management page
            </p>
          </div>
        ) : (
        ...
        {groups.length > 0 && (
          <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            <p className="text-sm text-blue-800 dark:text-blue-200">
              ...
              This user is a member of {groups.length} group{groups.length !== 1 ? 's' : ''}.
              Group managers can remove this user from their groups via the group management page.
            </p>
          </div>
        )}
      </div>
